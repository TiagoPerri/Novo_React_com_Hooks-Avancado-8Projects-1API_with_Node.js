...
function ConversorMoedas() {
  ...
  function handleValor(event){
    setValor(event.target.value.replace(/\D/g, '')); //D maisculo falo com todos os dados que NAO sao numeros, o g é de global, ou seja, todos os Nao numericos serão substituidos por ', ou seja, vazio
  }
